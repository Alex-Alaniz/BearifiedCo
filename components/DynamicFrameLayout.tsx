...
const initialFrames: Frame[] = [
  ...
  },
  {
    id: 5,
    video:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/_description_fixed_202507241440-aMyxG66f9bqzzNS3OQm4qkM0CPPzzY.mp4", // Replace with your new video
...
export default function DynamicFrameLayout() {
  ...
  return (
    <div className="space-y-4 w-full h-full">
      <div className="flex justify-end items-center mb-4 ml-8">
